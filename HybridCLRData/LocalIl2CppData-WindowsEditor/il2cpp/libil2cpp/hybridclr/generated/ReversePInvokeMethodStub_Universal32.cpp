...
namespace metadata
{
	...
	void __ReversePInvokeMethod_2(int32_t __arg0, int32_t __arg1, int32_t __arg2)
	{
        const MethodInfo* method = MetadataModule::GetMethodInfoByReversePInvokeWrapperIndex(2);
        typedef void (*Callback)(int32_t, int32_t, int32_t, const MethodInfo*);
		((Callback)(method->methodPointerCallByInterp))(__arg0, __arg1, __arg2, method);
	}

    ReversePInvokeMethodData g_reversePInvokeMethodStub[]
	{
		{"vi4i4", (Il2CppMethodPointer)__ReversePInvokeMethod_0},
		{"vi4i4", (Il2CppMethodPointer)__ReversePInvokeMethod_1},
		{"vi4i4i4", (Il2CppMethodPointer)__ReversePInvokeMethod_2},
